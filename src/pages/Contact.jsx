...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "aae8bea7-00a1-440a-be78-eea75101876d");
      ...
      <form onSubmit={onSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <input
            ...
            className="bg-transparent border border-borderDark rounded-xl px-4 py-3 text-textGray text-sm focus:border-accent focus:outline-none placeholder:text-gray-500"
            required
          />
          <input
            type="email"
        ...
        <textarea
          ...
          rows="5"
          className="w-full bg-transparent border border-borderDark rounded-xl px-4 py-3 text-textGray text-sm focus:border-accent focus:outline-none placeholder:text-gray-500"
          required
        ></textarea>
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="flex items-center gap-2 bg-[#2b2b2c] border border-borderDark text-accent px-6 py-3 rounded-xl hover:text-textLight hover:bg-borderDark transition-all text-sm font-medium shadow-sm"
          >
